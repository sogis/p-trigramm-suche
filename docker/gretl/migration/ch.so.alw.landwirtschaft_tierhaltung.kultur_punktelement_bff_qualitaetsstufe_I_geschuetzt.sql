...
index_base AS (
    SELECT
        'ch.so.alw.landwirtschaft_tierhaltung.kultur_punktelement_bff_qualitaetsstufe_I_geschuetzt'::text AS subclass,
        t_id AS id_in_class,
    ...
    FROM
        alw_landwirtschaft_tierhaltung_pub_v1.betrbsdttrktrdten_kultur_punktelement
)
SELECT
